...
# Aggregate results
# -----------------------------------------------------------------------------
list.all.bias <- list(betas = list(list.all.est.bias.betas),
                      means = list(list.all.est.bias.means),
                      AUC = list(list.all.est.bias.AUC),
                      diffs.eos.means = list(list.all.est.bias.diffs.eos.means),
                      diffs.AUC = list(list.all.est.bias.diffs.AUC)
)
