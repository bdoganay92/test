...
new.input.means$time.3[4:5] <- new.input.means$time.3[4:5] + 0.50*d
new.input.means$time.4[4:5] <- new.input.means$time.4[4:5] + 0.50*d
new.input.means$time.5[4:5] <- new.input.means$time.5[4:5] + 0.50*d
...
new.input.means$time.3[4:5] <- new.input.means$time.3[4:5] + 0.5*d
new.input.means$time.4[4:5] <- new.input.means$time.4[4:5] + d
new.input.means$time.5[4:5] <- new.input.means$time.5[4:5] + d
new.input.means$time.6[4:5] <- new.input.means$time.6[4:5] + d
