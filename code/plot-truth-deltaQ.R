###############################################################################
# Calculate true value of deltaQ; code for optional plotting of 
# EDTR mean trajectories
###############################################################################
...
#   - this.folder, this.scenario
#   - is.plot (TRUE or FALSE only)
...
if(is.plot){
  jpeg(file.path(path.output_data, this.folder, this.scenario, "plot_edtr_mean_trajectories.jpg"), width = 500, height = 500)
