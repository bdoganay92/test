...
###############################################################################
diff.change.score.plusplus.plusminus <- D.change.score %*% exp(stacked.C.plusplus.plusminus %*% beta.vec)
diff.change.score.plusplus.minusplus <- D.change.score %*% exp(stacked.C.plusplus.minusplus %*% beta.vec)
diff.change.score.plusplus.minusminus <- D.change.score %*% exp(stacked.C.plusplus.minusminus %*% beta.vec)
diff.change.score.plusminus.minusplus <- D.change.score %*% exp(stacked.C.plusminus.minusplus %*% beta.vec)
diff.change.score.plusminus.minusminus <- D.change.score %*% exp(stacked.C.plusminus.minusminus %*% beta.vec)
diff.change.score.minusminus.minusplus <- D.change.score %*% exp(stacked.C.minusminus.minusplus %*% beta.vec)
