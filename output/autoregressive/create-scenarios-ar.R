...
path.output_data <- Sys.getenv("path.output_data")
this.folder <- "autoregressive"
dir.create(path = file.path(path.output_data, this.folder, "sim_vary_n4"), recursive = TRUE)
...
for(idx.sim.scenarios in 1:10){
  ...
  dir.create(path = file.path(path.output_data, this.folder, "sim_vary_n4", paste("sim_results", idx.sim.scenarios, sep="_")), recursive = TRUE)
  write.csv(dat.mu, file = file.path(path.output_data, this.folder, "sim_vary_n4", paste("sim_results", idx.sim.scenarios, sep="_"), "input_means.csv"), row.names = FALSE)
  write.csv(dat.tau, file = file.path(path.output_data, this.folder, "sim_vary_n4", paste("sim_results", idx.sim.scenarios, sep="_"), "input_prop_zeros.csv"), row.names = FALSE)
}
...
path.output_data <- Sys.getenv("path.output_data")
this.folder <- "autoregressive"
dir.create(path = file.path(path.output_data, this.folder, "sim_vary_eta"), recursive = TRUE)
...
for(idx.sim.scenarios in 1:10){
  ...
  dir.create(path = file.path(path.output_data, this.folder, "sim_vary_eta", paste("sim_results", idx.sim.scenarios, sep="_")), recursive = TRUE)
  write.csv(dat.mu, file = file.path(path.output_data, this.folder, "sim_vary_eta", paste("sim_results", idx.sim.scenarios, sep="_"), "input_means.csv"), row.names = FALSE)
  write.csv(dat.tau, file = file.path(path.output_data, this.folder, "sim_vary_eta", paste("sim_results", idx.sim.scenarios, sep="_"), "input_prop_zeros.csv"), row.names = FALSE)
}
