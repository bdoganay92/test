...
.df.vary.params$power.eos.means.mid <- NA_real_
.df.vary.params$power.AUC.mid <- NA_real_
.df.vary.params$power.eos.means.low <- NA_real_
.df.vary.params$power.AUC.low <- NA_real_
.df.vary.params$power.eos.means.high <- NA_real_
.df.vary.params$power.AUC.high <- NA_real_


###############################################################################
# Employ Method 2 in Power Calculation
###############################################################################

.this.folder.alternative <- "sim_study_main/sim_results_null/truth"
...
for(.idx.vary.params in 1:nrow(.df.vary.params)){
  ...
  .df.vary.params[.idx.vary.params,"power.eos.means.mid"] <- power.diff.eos.means
  .df.vary.params[.idx.vary.params,"power.AUC.mid"] <- power.diff.AUC
...
.this.folder.alternative <- "sim_study_main/sim_results_null/below_truth"
...
for(.idx.vary.params in 1:nrow(.df.vary.params)){
  ...
  .df.vary.params[.idx.vary.params,"power.eos.means.low"] <- power.diff.eos.means
  .df.vary.params[.idx.vary.params,"power.AUC.low"] <- power.diff.AUC
...
.this.folder.alternative <- "sim_study_main/sim_results_null/above_truth"
...
for(.idx.vary.params in 1:nrow(.df.vary.params)){
  ...
  .df.vary.params[.idx.vary.params,"power.eos.means.high"] <- power.diff.eos.means
  .df.vary.params[.idx.vary.params,"power.AUC.high"] <- power.diff.AUC
