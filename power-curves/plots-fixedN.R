...
gg <- ggplot(collect.power.eos.means, aes(x=D.eos.means, y=power, color=datagen.params.rho, shape=datagen.params.rho, linetype=datagen.params.rho))
...
gg <- ggplot(collect.power.AUC, aes(x=D.average.AUC, y=power, color=datagen.params.rho, shape=datagen.params.rho, linetype=datagen.params.rho))
...
gg <- ggplot(collect.power.change.score, aes(x=D.change.score, y=power, color=datagen.params.rho, shape=datagen.params.rho, linetype=datagen.params.rho))
gg <- gg + scale_x_continuous(limits = c(-5, 0))
gg <- gg + scale_y_continuous(limits = c(0,1), breaks = seq(0,1,0.10))
gg <- gg + geom_line(size=1.2, show.legend = TRUE)
gg <- gg + geom_point(size=3, alpha=0.7)
...
gg <- ggplot(collect.coverage.eos.means, aes(x=D.eos.means, y=coverage, color=datagen.params.rho, shape=datagen.params.rho, linetype=datagen.params.rho))
gg <- gg + scale_x_continuous(limits = c(-5, 0))
gg <- gg + scale_y_continuous(limits = c(0,1), breaks = seq(0,1,0.10))
gg <- gg + geom_line(size=1.2, show.legend = TRUE)
gg <- gg + geom_point(size=3, alpha=0.7)
...
gg <- ggplot(collect.coverage.AUC, aes(x=D.average.AUC, y=coverage, color=datagen.params.rho, shape=datagen.params.rho, linetype=datagen.params.rho))
gg <- gg + scale_x_continuous(limits = c(-3, 0))
gg <- gg + scale_y_continuous(limits = c(0,1), breaks = seq(0,1,0.10))
gg <- gg + geom_line(size=1.2, show.legend = TRUE)
gg <- gg + geom_point(size=3, alpha=0.7)
...
gg <- ggplot(collect.coverage.change.score, aes(x=D.change.score, y=coverage, color=datagen.params.rho, shape=datagen.params.rho, linetype=datagen.params.rho))
gg <- gg + scale_x_continuous(limits = c(-5, 0))
gg <- gg + scale_y_continuous(limits = c(0,1), breaks = seq(0,1,0.10))
gg <- gg + geom_line(size=1.2, show.legend = TRUE)
gg <- gg + geom_point(size=3, alpha=0.7)
...
path.output_data <- Sys.getenv("path.output_data")
ggsave(file.path(path.output_data, use.working.corr, "coveragecurves.fixedN.jpg"), 
